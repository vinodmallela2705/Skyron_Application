				...
				<div class="col-md-12">
					<div class="welcome-box">
						<div class="welcome-img">
							<img alt="" src="assets/skyronImages/employeeIcon.png">
						</div>
						<div class="welcome-det">
							<h3>
								Welcome,
								<%=employeeName %></h3>
							<p><%=dateTimeformatter.format(dateTime)	%></p>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="dash-info-list">
								<a href="#" class="dash-card">
									<div class="dash-card-container">
										...
										<div class="dash-card-avatars">
											<div class="e-avatar">
												<img src="<%=employeeImage %>" height="40" alt="">
											</div>
										</div>
									</div>
								</a>
									...
									<div class="dash-card-container">
										...
										<div class="dash-card-avatars">
											<a href="#" class="e-avatar"><img
												src="assets/img/profiles/avatar-04.jpg" alt=""></a> <a
												href="#" class="e-avatar"><img
												src="assets/img/profiles/avatar-08.jpg" alt=""></a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="dash-info-list">
								<div class="dash-card">
									<div class="dash-card-container">
										...
										<div class="dash-card-avatars">
											<a href="#" class="e-avatar"><img
												src="assets/img/profiles/avatar-05.jpg" alt=""></a> <a
												href="#" class="e-avatar"><img
